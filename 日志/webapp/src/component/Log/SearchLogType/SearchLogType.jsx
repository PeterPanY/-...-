...
let SearchLogType = React.createClass({
  getInitialState() {
    return ({
      logTypeData: [],
      visible: false,
              ...
              return (
                <li key={index}>{item.typeName}
                  <div style={{ float: 'right' }}>
                    <a href="javascript:;" onClick={_this.changeLogType.bind(null, item.blogTypeId, item.typeName)}>修改</a>
...
SearchLogType = createForm()(SearchLogType);
export default SearchLogType
